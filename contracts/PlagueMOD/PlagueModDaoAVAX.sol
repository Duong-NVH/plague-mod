...
contract PlagueModDividendTracker is IDividendDistributor {
...
contract PlagueModDaoAVAX is Ownable, IERC20 {
    using SafeMath for uint256;
    ...
    address treasuryWallet = address(0); //change this
    address liquidityWallet;

    ITraderJoeRouter public router; //trader joe
    address pair; 

    PlagueModDividendTracker public dividendTracker;
    ...
    constructor () {
        ...
        dividendTracker = new PlagueModDividendTracker();
